...
// nix-shell
// sudo qmk flash -kb keychron/q2/ansi_encoder -km exformation
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [WIN_BASE] = LAYOUT_ansi_67(
        TG(_FN2),                KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,  KC_EQL,    KC_BSPC,          KC_MUTE,
        ...
        _______, KC_LGUI, KC_LALT,                            KC_SPC,                             TG(_FN2), MO(_FN2), MO(_FN3),  KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FN2] = LAYOUT_ansi_67(
        ...
        KC_GRV,  QK_REP,KC_BTN1, KC_BTN2, RGB_SAD, RGB_SPD, _______, _______, _______, _______, _______, _______,             _______,          _______,
